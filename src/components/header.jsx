        ...
        <>
            <nav className="bg-white sticky top-0 z-10 shadow-xl border-gray-200 dark:border-gray-600 dark:bg-gray-900">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    ...
                    <div id="mega-menu-full" className={`items-center justify-between font-medium ${toggleMenu ? "absolute top-10 left-0" : "hidden"} md:relative md:top-0 w-full md:flex md:w-auto md:order-1`}>
